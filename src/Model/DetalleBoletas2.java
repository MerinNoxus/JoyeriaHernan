...
public class DetalleBoletas2 {
    ...
    public DetalleBoletas2(String CP_deBol, String descripcion_deBol, int cantidad_deBol, double precioUnit_deBol, double precioVenta_deBol, String Kilates_deBol, String material_deBol) {
